...
use constant TOPHATP    => ('1.4.1'  => '/usr/local2/tophat-1.4.1.Linux_x86_64/',
			    '2.0.5'  => '/usr/local2/tophat-2.0.5.Linux_x86_64/',
			    '2.0.9'  => '/usr/local2/tophat-2.0.9.Linux_x86_64/',
			    '2.0.11' => '/usr/local2/tophat-2.0.11.Linux_x86_64/');
use constant BOWTIEP    => ('0.12.7' => '/usr/local2/bowtie-0.12.7/',
			    '2.0.0'  => '/usr/local2/bowtie2-2.0.0-beta7/',
			    '2.1.0'  => '/usr/local2/bowtie2-2.1.0/',
			    '2.2.2'  => '/usr/local2/bowtie2-2.2.2/');
